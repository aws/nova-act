...
async def take_observation(page: Page, dimensions: DimensionsDict | None = None, save_screenshot: bool = False) -> str:
    """
    ...
    screenshot_data_url = await take_screenshot_as_data_url(page)
