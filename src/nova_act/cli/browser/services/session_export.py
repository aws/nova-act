...
"""Session export business logic — pure data transformation and file I/O."""
...
from nova_act.cli.browser.services.session_recorder import CommandEntry, SessionManifest
...
def _enrich_entry(entry: CommandEntry) -> CommandEntry:
    ...
    if cmd_type == "ai_command" and entry.get("steps_file"):
        ...
        try:
            ...
            logger.warning("Failed to load steps summary from '%s'", entry.get("steps_file", ""), exc_info=True)
