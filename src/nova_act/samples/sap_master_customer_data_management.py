...
"""Simple example of modifying customer details in SAP Master customer data management.
...
def main(record_video: bool = False) -> None:
    with NovaAct(
        ...
        nova.act("look for search box under Standard view and search for 'Copenhagen municipality'")
